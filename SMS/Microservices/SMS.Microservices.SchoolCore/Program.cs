using SMS.Microservices.SchoolCore.MappingProfiles;
using Polly;
using MassTransit;
...
builder.Services.AddAutoMapper(typeof(SchoolCoreMappingProfile).Assembly);
...
{
    options.UseNpgsql(builder.Configuration.GetConnectionString("SchoolCoreDbConnection"));
});
